...
\begin{document}
	...
	The aim of the WDAqua project is to advance the state of the art in the challenging research field of data-driven QA by interleaving the tasks of training, research, and innovation.
